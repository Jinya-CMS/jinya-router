...
```
cd existing_repo
git remote add origin https://gitlab.imanuel.dev/jinya-cms/jinya-router.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.imanuel.dev/jinya-cms/jinya-router/-/settings/integrations)
